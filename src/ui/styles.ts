...
.nav-item .nav-icon { display: flex; align-items: center; justify-content: center; width: 24px; height: 24px; }
...
.nav-item.active::after {
  ...
  width: 24px; height: 2px; background: var(--accent); border-radius: 1px; box-shadow: 0 0 8px var(--accent);
}
...
.home-city-icon { margin-bottom: 12px; color: var(--accent); display: flex; justify-content: center; }
.home-city-icon svg { width: 32px; height: 32px; }
...
.map-stat-chip {
  ...
  padding: 6px 16px; backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px);
}
.chip-item { display: flex; align-items: center; gap: 4px; }
.chip-value { font-size: 15px; font-weight: 800; color: var(--text-primary); }
.chip-value.amber { color: var(--amber); }
.chip-label { font-size: 10px; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.3px; font-weight: 600; }
.chip-divider { width: 1px; height: 16px; background: var(--border-strong); margin: 0 12px; }
...
.map-ctrl-btn {
  ...
  background: var(--glass-bg); color: var(--text-primary); display: flex; align-items: center;
  justify-content: center; cursor: pointer;
  box-shadow: 0 2px 12px rgba(0,0,0,0.4); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px);
  transition: background 0.15s ease;
}
.map-ctrl-btn svg { width: 18px; height: 18px; }
.map-ctrl-btn:active { background: rgba(255,255,255,0.08); }
...
.map-search-bar {
  ...
  padding: 6px 10px; backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px);
}
.map-search-input {
...
.map-search-close:hover { background: rgba(255,255,255,0.08); }
.map-search-close svg { width: 16px; height: 16px; }
...
.no-group-cards { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; padding: 40px 0; }
.no-group-card {
  display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px;
  padding: 32px 16px; border-radius: var(--radius); border: 1px solid var(--border);
  background: var(--bg-card); cursor: pointer; transition: border-color 0.2s, background 0.2s;
}
.no-group-card:hover { border-color: var(--border-strong); background: var(--bg-card-hover); }
.no-group-card svg { color: var(--text-secondary); }
.no-group-card-title { font-size: 15px; font-weight: 700; color: var(--text-primary); }
...
.member-detail { font-size: 12px; color: var(--text-secondary); display: flex; align-items: center; gap: 4px; }
.member-skill-icon { display: inline-flex; align-items: center; }
.member-skill-icon svg { width: 14px; height: 14px; }
...
.mgmt-btn:hover { background: var(--bg-card-hover); }
.mgmt-icon { display: flex; align-items: center; justify-content: center; width: 20px; color: var(--text-secondary); }
.mgmt-icon svg { width: 18px; height: 18px; }
.mgmt-text { flex: 1; }
.mgmt-name { font-size: 14px; font-weight: 600; }
.mgmt-desc { font-size: 11px; color: var(--text-secondary); }
.mgmt-arrow { color: var(--text-muted); display: flex; align-items: center; }
.mgmt-arrow svg { width: 16px; height: 16px; }
.mgmt-danger .mgmt-name { color: var(--danger); }
.mgmt-danger .mgmt-icon { color: var(--danger); }

/* ========== MODALS ========== */
.modal-overlay {
  position: fixed; inset: 0; background: rgba(8,8,12,0.8); display: flex;
...
.skill-timing-note {
  ...
  background: rgba(255, 184, 48, 0.06); border: 1px solid rgba(255, 184, 48, 0.12);
  border-radius: var(--radius-sm); font-size: 12px; color: var(--text-secondary); line-height: 1.4;
}
.skill-timing-note strong { color: var(--amber); }
.skill-timing-icon { flex-shrink: 0; color: var(--amber); display: flex; align-items: center; }
.skill-timing-icon svg { width: 16px; height: 16px; }
...
.skill-card.equipped { border-color: var(--accent); box-shadow: 0 0 16px var(--accent-dim), inset 0 0 0 1px rgba(255,106,0,0.08); }
.skill-top { display: flex; align-items: flex-start; gap: 12px; margin-bottom: 10px; }
.skill-icon { width: 40px; height: 40px; border-radius: var(--radius-sm); background: rgba(255,255,255,0.04); display: flex; align-items: center; justify-content: center; flex-shrink: 0; color: var(--text-secondary); }
.skill-card.equipped .skill-icon { background: var(--accent-dim); color: var(--accent); }
...
.skill-val { color: var(--amber); font-weight: 700; }
.equipped-badge {
...
.skill-level-bar { display: flex; align-items: center; gap: 3px; }
.skill-level-seg {
  width: 20px; height: 6px; border-radius: 3px; background: rgba(255, 255, 255, 0.06);
  transition: background 0.2s;
}
.skill-level-seg.filled { background: var(--accent); box-shadow: 0 0 6px rgba(255, 106, 0, 0.3); }
.skill-level-label { font-size: 11px; color: var(--text-secondary); margin-left: 8px; font-weight: 600; }
.skill-actions { display: flex; align-items: center; flex-shrink: 0; }
.skill-upgrade-btn {
...
.skill-upgrade-btn svg { flex-shrink: 0; }
...
.eq-icon { width: 36px; height: 36px; border-radius: var(--radius-sm); background: var(--accent-dim); display: flex; align-items: center; justify-content: center; color: var(--accent); }
.eq-icon svg { width: 20px; height: 20px; }
...
.settings-icon { display: flex; align-items: center; justify-content: center; width: 20px; color: var(--text-secondary); }
...
.cell-info-popup {
  ...
  box-shadow: 0 8px 32px rgba(0,0,0,0.6); animation: slideUp 0.2s ease;
}
...
.cell-info-close:hover { background: rgba(255,255,255,0.08); }
.cell-info-close svg { width: 14px; height: 14px; }
...
.run-result-skill {
  ...
  background: rgba(255, 184, 48, 0.08); border-radius: var(--radius-sm);
}
.run-result-skill.dice-roll { color: var(--green); background: rgba(74, 222, 128, 0.08); margin-top: 6px; }
.run-result-rp-detail {
...
.run-breakdown-row.bonus { color: var(--amber); }
.run-breakdown-row.dice { color: var(--green); }
.run-breakdown-row.capture { color: var(--green); }
.run-breakdown-row.total { color: var(--text-primary); font-weight: 700; font-size: 14px; }
.run-breakdown-sub {
  font-size: 10px; color: var(--text-muted); padding: 0 0 4px 0;
}
.run-breakdown-divider {
...
.turf-popup .leaflet-popup-tip { background: var(--bg-card-solid); border: 1px solid var(--border-strong); }
...
.profile-dropdown-item span { width: 18px; display: flex; align-items: center; justify-content: center; }
.profile-dropdown-item span svg { width: 16px; height: 16px; }
...
.dev-btn.small { padding: 4px 10px; font-size: 11px; }
.dev-btn.danger { background: var(--danger); }
.dev-log { padding: 6px 14px; font-size: 11px; color: var(--green); min-height: 20px; }

/* Dev Strava Activity List */
.dev-strava-list { max-height: 300px; overflow-y: auto; margin-top: 8px; }
.dev-strava-item {
  display: flex; justify-content: space-between; align-items: center;
  padding: 8px 0; border-bottom: 1px solid var(--border); gap: 8px;
}
.dev-strava-item:last-child { border-bottom: none; }
.dev-strava-info { flex: 1; min-width: 0; }
.dev-strava-name { font-size: 12px; color: var(--text-primary); font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.dev-strava-meta { font-size: 10px; color: var(--text-muted); margin-top: 2px; }
.dev-strava-badge { font-size: 10px; padding: 2px 8px; border-radius: 4px; white-space: nowrap; }
.dev-strava-badge.imported { background: rgba(74, 222, 128, 0.15); color: var(--green); }
.dev-strava-empty { font-size: 12px; color: var(--text-muted); padding: 12px 0; text-align: center; }
...
.sync-toast.visible { transform: translateX(-50%) translateY(0); }
.sync-toast.success { border-color: var(--green); color: var(--green); }
.sync-toast.info { border-color: var(--amber); color: var(--amber); }
`;
}
